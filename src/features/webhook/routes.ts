...
router.put(
  "/:id",
  validate({ ...webhookSchemas.getWebhookSchema, ...webhookSchemas.updateWebhookSchema }),
...
router.get(
  "/:id/deliveries",
  validate({ ...webhookSchemas.getWebhookSchema, ...webhookSchemas.webhookDeliveriesQuerySchema }),
