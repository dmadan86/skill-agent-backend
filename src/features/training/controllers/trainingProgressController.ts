...
export const getTrainingProgress = async (
  ...
  try {
    ...
    const progress = await trainingProgressService.getTrainingProgress(sessionId, userId);
...
export const getTrainingProgressByProgressId   = async (
  ...
  try {
    ...
    const progress = await trainingProgressService.getTrainingProgressByProgressId(progressId);
...
export const listUserTrainingProgress = async (
  ...
  try {
    ...
    const progressList = await trainingProgressService.listUserTrainingProgress(userId);
...
export const resetProgress = async (
  ...
  try {
    ...
    const progress = await trainingProgressService.resetProgress(sessionId, userId);
