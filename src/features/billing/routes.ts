...
router.get('/plans/:id', validate(billingSchemas.getBillingPlanSchema), billingPlanController.getBillingPlan);

// All other billing routes require authentication
router.use(authenticate);

router.post('/plans', validate(billingSchemas.createBillingPlanSchema), billingPlanController.createBillingPlan);
router.put('/plans/:id', validate(billingSchemas.updateBillingPlanSchema), billingPlanController.updateBillingPlan);
router.delete('/plans/:id', validate(billingSchemas.getBillingPlanSchema), billingPlanController.deleteBillingPlan);
