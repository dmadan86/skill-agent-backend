...
export class SubscriptionExistsError extends AppError {
  constructor() {
    super(
      "An active subscription already exists for this team",
      "SUBSCRIPTION_EXISTS",
      409,
    );
  }
...
export class PaymentMethodInvalidError extends AppError {
  constructor() {
    super(
      "Payment method is invalid or incomplete",
...
export class TeamSubscriptionAccessDeniedError extends AppError {
  constructor() {
    super(
      "You do not have permission to manage this team's subscription",
...
export class TeamInvoiceAccessDeniedError extends AppError {
  constructor() {
    super(
      "You do not have permission to access this team's invoices",
